...
the initials and finals in East Timorese Hakka. Click on the example cell to hear
the syllable being pronounced.

## Table of initials

<PhonoTable colTitles={['Initial', 'IPA', 'Example', 'Comments']} audioPath="initials" data={initials}/>

## Table of finals

<PhonoTable colTitles={['Final', 'IPA', 'Example', 'Comments']}audioPath="finals" data={finals}/>
...
Next, let's move onto learning about <Link href="/tones">Tones.</Link>